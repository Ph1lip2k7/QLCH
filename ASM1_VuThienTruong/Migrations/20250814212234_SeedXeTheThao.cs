    ...
    public partial class SeedXeTheThao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Các mẫu điện thoại thông minh", "Điện thoại" },
                    { 2, "Ốp lưng, sạc, tai nghe", "Phụ kiện" }
                });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Email", "Fullname", "PasswordHash", "Username", "role" },
                values: new object[,]
                {
                    { 1, "admin@example.com", "Quản trị viên", "123456", "admin", "Admin" },
                    { 2, "a@example.com", "Nguyễn Văn A", "123456", "user1", "Customer" },
                    { 3, "b@example.com", "Trần Thị B", "123456", "user2", "Customer" }
                });
